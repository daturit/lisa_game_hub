...
class ThemeNotifier with ChangeNotifier {
  final darkTheme = ThemeData(
      ...
      useMaterial3: true,
      colorScheme: ColorScheme.fromSwatch(primarySwatch: MyPalette.firstPalette, brightness: Brightness.dark)
  ...
  final lightTheme = ThemeData(
      ...
      useMaterial3: true,
      colorScheme: ColorScheme.fromSwatch(primarySwatch: MyPalette.firstPalette, brightness: Brightness.light)
